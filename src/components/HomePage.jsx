...
function Home() {
    const CategoryCard = ({ imgSrc, imgAlt, category }) => {
        ...
        return(
            <div className="category-card" onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)} >
                <img className="category-image" src={imgSrc} alt={imgAlt} style={{opacity: hovered ? 1 : 0.5, transition: 'opacity 0.2s ease-in-out'}} />
    ...
    <Box sx={{ top: 0, left: 0, pt: 4, backgroundColor: 'background', pb: 20}}>
        <Grid container spacing={3} sx={{ top: 0, left: 0, display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
            <Grid size={9} sx={{py: 2}} >
                <Typography variant='h1' align="center" sx={{ pt: 3, color: 'text.primary', height: 'auto'}}>
                    Community Answers
                </Typography>
            </Grid>
            <Grid size={9}>
                <Typography variant='h4' align="center" sx={{ py: 2, color: 'text.primary'}}>
                    These are some of my fav movies!
                    <br />
                    Let me know how you would rate them.
                </Typography>
            </Grid>
            <Grid size={9}>
            ...
            <Grid container size={12} spacing={12} justifyContent={'center'} sx={{ px: 20}}>        
                <Grid item size={{ md:4, sm:8, xs:11  }}>
                    <Link to="/action" style={{ textDecoration: 'none', color: 'inherit' }}>
                        <CategoryCard
                            imgSrc={actionPic}
                            imgAlt="Action"
                            category="ACTION"  
                ...
                <Grid item size={{  md:4, sm:8, xs:11  }}>
                    <Link to="/anime" style={{ textDecoration: 'none', color: 'inherit' }}>
                        <CategoryCard
                            imgSrc={animePic}
                            imgAlt="Animation"
                ...
                <Grid item size={{  md:4, sm:8, xs:11  }}>
                    <Link to="/scifi" style={{ textDecoration: 'none', color: 'inherit' }}>
                        <CategoryCard
                            imgSrc={scifiPic}
